...
app.post('/add_candidate', upload.any(), function (req, res, next) {
  ...
  var user_first=name.substring(0,4);
  var cand_id = user_first+x;  // for candidate id 
  console.log('check:'+cand_id);
...
app.post('/update_profile', upload.any(), function (req, res, next) {
  ...
  var post = req.body;
  console.log('My array:' + myObj.length);
...
app.get('/find_relieving', user.find_relieving);
app.post('/find_relieving', user.find_relieving);
