...
exports.find_relieving = function (req, res, next) {
   var post = req.body;
   var message = '';
   var relieving_type=post.relieving_type;
   console.log('Relieved:'+relieving_type);
     
   if(relieving_type=="All")
   {
      var sql = "SELECT * FROM `ems`.`cand_profile_details`;"
      db.query(sql, function (err, data1) {
         var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
   ...
   else
   {
       ...
       var sql1 = "SELECT * FROM `ems`.`cand_admission_details` INNER JOIN `ems`.`cand_relieving_details` on `cand_relieving_details`.`cand_id` = `cand_admission_details`.`cand_id` where `cand_relieving_details`.`relieved` = '" + relieving_type + "'";;
   db.query(sql1, function (err, data1) {
   var sql2 ="SELECT * FROM `ems`.`cand_admission_details` INNER JOIN `ems`.`cand_relieving_details` on `cand_relieving_details`.`cand_id` = `cand_admission_details`.`cand_id` where `cand_relieving_details`.`relieved` = '" + relieving_type + "'";
      db.query(sql2, function (err, data) {
         res.render('find_relieving.ejs', { userData: data, userData1: data1, message: message });
      });
   });
}
};
//-----------------------------------------------dashboard page functionality----------------------------------------------
exports.aissc_board = function (req, res, next) {
   var message = '';
   var userId = req.session.userId;
   var sql = "SELECT * FROM `ems`.`cand_profile_details`;"
   db.query(sql, function (err, data1) {
      var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
      db.query(sql, function (err, data) {
         res.render('aissc_board.ejs', { userData: data, userData1: data1, message: message });
      });
   });
};
//-----------------------------------------------dashboard page functionality----------------------------------------------
exports.mdms_board = function (req, res, next) {
   var message = '';
   var userId = req.session.userId;
   var sql = "SELECT * FROM `ems`.`cand_profile_details`;"
   db.query(sql, function (err, data1) {
      var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
      db.query(sql, function (err, data) {
         res.render('mdms_board.ejs', { userData: data, userData1: data1, message: message });
      });
   });
};
//-----------------------------------------------dashboard page functionality----------------------------------------------
exports.nursing = function (req, res, next) {
   var message = '';
   var userId = req.session.userId;
   var sql = "SELECT * FROM `ems`.`cand_profile_details`;"
   db.query(sql, function (err, data1) {
      var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
      db.query(sql, function (err, data) {
         res.render('nursing.ejs', { userData: data, userData1: data1, message: message });
      });
   });
};
//-----------------------------------------------dashboard page functionality----------------------------------------------
exports.bsc_board = function (req, res, next) {
   var message = '';
   var userId = req.session.userId;
   var sql = "SELECT * FROM `ems`.`cand_profile_details`;"
   db.query(sql, function (err, data1) {
      var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
      db.query(sql, function (err, data) {
         res.render('bsc_board.ejs', { userData: data, userData1: data1, message: message });
      });
   });
};
//-----------------------------------------------dashboard page functionality----------------------------------------------
